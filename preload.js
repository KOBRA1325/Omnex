...
contextBridge.exposeInMainWorld('nexus', {
  ...
  setupFivemDatabase: (serverId)      => ipcRenderer.invoke('setup-fivem-database', serverId),
  getFivemDbStatus:   (serverId)      => ipcRenderer.invoke('get-fivem-db-status', serverId),
  migrateFivemDbFromMysql: (serverId) => ipcRenderer.invoke('migrate-fivem-db-from-mysql', serverId),
  migrateFivemDbFromFile:  (serverId) => ipcRenderer.invoke('migrate-fivem-db-from-file', serverId),
